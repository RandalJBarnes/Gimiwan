...
//--------------------------------------------------------------------------
   ...
   bool TestDotProduct()
   {
      ...
      bool flag = true;
      flag &= CHECK( abs(DotProduct(A, A) - 30) < TOLERANCE );
      flag &= CHECK( abs(DotProduct(A, B) - 30) < TOLERANCE );
      flag &= CHECK( abs(DotProduct(A, C) - 20) < TOLERANCE );
      flag &= CHECK( abs(DotProduct(A, D) - 20) < TOLERANCE );
      return flag;
   }
